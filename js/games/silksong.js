    ...
    completionMap: [
        {
            ...
            items: [
                ...
                { name: "亡虫囊/壳囊", checkTools: (toolsMap) => toolsMap["Dead Mans Purse"]?.IsUnlocked },
        ...
        },
        {
            ...
            items: [
                ...
                { name: "弧爪/曲镰", checkTools: (toolsMap) => toolsMap["Curve Claws"]?.IsUnlocked },
                ...
                // { name: "丝弹", checkTools: (toolsMap) => toolsMap["Silk Snare"]?.IsUnlocked },
