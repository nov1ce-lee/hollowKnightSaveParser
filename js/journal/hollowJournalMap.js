(function(window) {
    ...
    window.JOURNAL_MAPS.hollow = {
        entries: [
            ...
            { name: "提克提克", killedKey: "killedClimber", killsKey: "killsClimber", wiki: getWiki("提克提克"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/9/91/B_Tiktik.png" },
            ...
            { name: "格鲁兹", killedKey: "killedBouncer", killsKey: "killsBouncer", wiki: getWiki("格鲁兹"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/6/63/B_Gruzzer.png" },
            ...
            { name: "戈姆", killedKey: "killedWorm", killsKey: "killsWorm", wiki: getWiki("戈姆"), icon: "https://huiji-thumb.huijistatic.com/hkss/uploads/thumb/b/b1/B_Goam.png/136px-B_Goam.png" },
            ...
            { name: "埋葬躯壳", killedKey: "killedMummy", killsKey: "killsMummy", wiki: getWiki("埋葬躯壳"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/6/65/B_Entombed_Husk.png" },
            { name: "蛆虫", killedKey: "killedPrayerSlug", killsKey: "killsPrayerSlug", wiki: getWiki("蛆虫"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/5/53/B_Maggot.png" },
            ...
            { name: "苔藓爬虫", killedKey: "killedMossWalker", killsKey: "killsMossWalker", wiki: getWiki("苔藓爬虫"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/c/c1/B_Mosscreep.png" },
            { name: "苔藓蝶", killedKey: "killedMossFlyer", killsKey: "killsMossFlyer", wiki: getWiki("苔藓蝶"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/a/af/B_Mossfly.png" },
            { name: "苔藓怪", killedKey: "killedMossmanRunner", killsKey: "killsMossmanRunner", wiki: getWiki("苔藓怪"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/4/47/B_Mosskin.png" },
            { name: "爆炸苔藓怪", killedKey: "killedMossmanShaker", killsKey: "killsMossmanShaker", wiki: getWiki("爆炸苔藓怪"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/1/1b/B_Volatile_Mosskin.png" },
            ...
            { name: "阿鲁巴", killedKey: "killedLazyFlyer", killsKey: "killsLazyFlyer", wiki: getWiki("阿鲁巴"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/c/ce/B_Aluba.png" },
            ...
            { name: "带电光蝇", killedKey: "killedZapBug", killsKey: "killsZapBug", wiki: getWiki("带电光蝇"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/7/71/B_Charged_Lumafly.png" },

            { name: "漫步菇", killedKey: "killedFungCrawler", killsKey: "killsFungCrawler", wiki: getWiki("漫步菇"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/c/c3/B_Ambloom.png" },
            ...
            { name: "真菌球", killedKey: "killedFungusFlyer", killsKey: "killsFungusFlyer", wiki: getWiki("真菌球"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/1/1c/B_Fungoon.png" },
            { name: "斯孢格", killedKey: "killedMushroomTurret", killsKey: "killsMushroomTurret", wiki: getWiki("斯孢格"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/7/72/B_Sporg.png" },
            ...
            { name: "蘑菇战士", killedKey: "killedMushroomRoller", killsKey: "killsMushroomRoller", wiki: getWiki("蘑菇战士"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/c/ce/B_Shrumal_Warrior.png" },
            { name: "蘑菇巨怪", killedKey: "killedMushroomBrawler", killsKey: "killsMushroomBrawler", wiki: getWiki("蘑菇巨怪"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/c/c8/B_Shrumal_Ogre.png" },
            ...
            { name: "鲁多", killedKey: "killedGrassHopper", killsKey: "killsGrassHopper", wiki: getWiki("鲁多"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/f/f0/B_Loodle.png" },
            ...
            { name: "大型躯壳哨兵", killedKey: "killedGreatShieldZombie", killsKey: "killsGreatShieldZombie", wiki: getWiki("大型躯壳哨兵"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/6/63/B_Great_Husk_Sentry.png" },
            ...
            { name: "爆肚蝠", killedKey: "killedCeilingDropper", killsKey: "killsCeilingDropper", wiki: getWiki("爆肚蝠"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/7/77/B_Belfly.png" },
            ...
            { name: "爆炸格鲁兹", killedKey: "killedBurstingBouncer", killsKey: "killsBurstingBouncer", wiki: getWiki("爆炸格鲁兹"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/7/7b/B_Volatile_Gruzzer.png" },
            { name: "暴力躯壳", killedKey: "killedBurstingZombie", killsKey: "killsBurstingZombie", wiki: getWiki("暴力躯壳"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/7/74/Violent_Husk_Idle.png" },
            { name: "流涎躯壳", killedKey: "killedSpittingZombie", killsKey: "killsSpittingZombie", wiki: getWiki("流涎躯壳"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/a/a6/Slobbering_Husk_Idle.png" },
            ...
            { name: "死亡鲁多", killedKey: "killedColHopper", killsKey: "killsColHopper", wiki: getWiki("死亡鲁多"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/4/47/B_Death_Loodle.png" },
            ...
            { name: "装甲斯奎特", killedKey: "killedColMosquito", killsKey: "killsColMosquito", wiki: getWiki("装甲斯奎特"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/2/2c/B_Armoured_Squit.png" },
            ...
            { name: "苍白潜伏者", killedKey: "killedPaleLurker", killsKey: "killsPaleLurker", wiki: getWiki("苍白潜伏者"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/b/b7/Pale_Lurker_Idle.png" },
            ...
            { name: "肥波", killedKey: "killedBlowFly", killsKey: "killsBlowFly", wiki: getWiki("肥波"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/1/13/B_Boofly.png" },
            ...
            { name: "皇室家臣", killedKey: "killedWhiteRoyal", killsKey: "killsWhiteRoyal", wiki: getWiki("皇室家臣"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/8/87/B_Royal_Retainer.png" },
            ...
            { name: "暗影", killedKey: "hasJournal", killsKey: "completionPercent", wiki: getWiki("暗影"), icon: "https://huiji-public.huijistatic.com/hkss/uploads/a/af/Shade_Idle.png" },
